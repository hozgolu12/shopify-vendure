...
export class Migration1762013653745 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "production_order" ADD "tenantMongoId" character varying`, undefined);
        await queryRunner.query(`ALTER TABLE "production_order" ADD "workspaceMongoId" character varying`, undefined);
        await queryRunner.query(`ALTER TABLE "production_order_task" ADD "tenantMongodbId" character varying`, undefined);
        await queryRunner.query(`ALTER TABLE "production_order_task" ADD "workspaceMongoId" character varying`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "production_order_task" ADD "createdByMongoId" character varying`, undefined);
        await queryRunner.query(`ALTER TABLE "artisan_task_timesheet" ADD "tenantMongoId" text`, undefined);
        await queryRunner.query(`ALTER TABLE "artisan_task_timesheet" ADD "workspaceMongoId" character varying`, undefined);
        await queryRunner.query(`ALTER TABLE "artisan_task_timesheet" ADD "artisanMongoId" character varying`, undefined);
        await queryRunner.query(`ALTER TABLE "artisan_task_timesheet" ADD "createdByMongoId" character varying`, undefined);
        ...
        await queryRunner.query(`CREATE TYPE "public"."production_order_task_status_enum" AS ENUM('to do', 'in_progress', 'on_hold', 'completed')`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "artisan_task_timesheet" ADD "startDate" TIMESTAMP WITH TIME ZONE`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "production_order_task" DROP COLUMN "tenantMongodbId"`, undefined);
